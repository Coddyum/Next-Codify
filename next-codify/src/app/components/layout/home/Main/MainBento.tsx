                ...
                <div
                    ...
                    <div className="flex flex-col gap-5 ml-5">
                        <div className="flex gap-5">
                            <div className="card w-300 h-300 bg-transparent rounded-3xl flex items-center justify-center">
                                <div className="w-[294px] h-[294px] bg-bunker-950 rounded-3xl z-20"></div>
                            </div>
                            <div className="card2 card w-600 h-300 bg-transparent rounded-3xl flex items-center justify-center">
                    ...
                    <div className="card3 card w-300 h-616 bg-transparent rounded-3xl flex items-center justify-center">
